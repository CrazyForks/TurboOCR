...
Generalized from scripts/omnidoc_run_and_score.py (which is hardwired to the
...
Workflow:
  1. (re)generate the N-doc subset GT via scripts/omnidoc_subset_n.py.
...
SUBSET_SCRIPT = REPO / "scripts" / "omnidoc_subset_n.py"
RUN_TOOL = REPO / "tools" / "omnidoc_run.py"
MD_TOOL = REPO / "tools" / "omnidoc_to_md.py"
