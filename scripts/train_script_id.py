...
Locked-in contract (matches C++ ScriptId stub in src/lang_cls/script_id.h):
...
def main():
    ...
    ap.add_argument("--out", default="/home/nataell/code/epAiland/paddle-highspeed-cpp/models/script_id")
