...
# Copy instrumented sources (staged in docker/experiments/ during build)
COPY docker/experiments/vlm_formula_instrumented.cpp /app/src/formula/vlm_formula.cpp
COPY docker/experiments/vlm_table_instrumented.cpp   /app/src/table/vlm_table.cpp
