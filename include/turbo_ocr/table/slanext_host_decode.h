...
// CUDA-free: used by the CPU encoder-split table backend. The GPU
// SlanextEncSplit keeps its own inline copy (the TRT path stays untouched);
// this is the byte-identical CPU-only sibling.
