...
The routing logic itself is unit-tested in tests/cpp/test_cjk_stats.cpp; this
...
# Load the server-spawning helpers by path (this dir is a package, so a bare
# `from test_boot_config import ...` fails when pytest imports us as
# integration.test_formula_auto_cjk).
_spec = importlib.util.spec_from_file_location(
    "_boot_config_helpers", Path(__file__).parent / "test_boot_config.py")
