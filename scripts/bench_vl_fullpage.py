...
(`tools/omnidoc_run_paddlevl.py` — local PP-DocLayoutV3 layout, then VL on EVERY region incl. text)
...
for scoring (both auto-detected). Reuses scripts/omnidoc_run_and_score_n.py for the subset + scorer.
"""
import argparse
import json
import os
...
VL_RUNNER = REPO / "tools" / "omnidoc_run_paddlevl.py"
