...
OMNI = Path("/home/nataell/code/epAiland/omnidocbench/data")
PREDS = Path("/tmp/omnidoc_predictions/json")
ONNX = Path("/home/nataell/code/epAiland/paddle-highspeed-cpp/models/script_id/script_id.onnx")
OUT = Path("/home/nataell/code/epAiland/paddle-highspeed-cpp/models/script_id/ood_smoke.json")
