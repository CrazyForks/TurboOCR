...
Mirrors scripts/quantize_onnx_int8.py — only the modelopt arguments differ:
...
var is set (see src/engine/onnx_to_trt.cpp `fp8_onnx_path`).
...
Calibration data: scripts/calibration_data.py — same 200 stratified
