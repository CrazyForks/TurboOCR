#!/usr/bin/env python3
"""Profile-driven CPU OCR benchmark. Starts paddle_cpu_server with a given env,
...
Usage: cpu_profile_bench.py [label] [KEY=VAL ...]   # extra env for the server
"""
import base64, glob, hashlib, json, os, signal, subprocess, sys, time, urllib.request

REPO = "/home/nataell/code/epAiland/paddle-highspeed-cpp"
BIN = f"{REPO}/build_cpu/paddle_cpu_server"
FUNSD = "/home/nataell/code/epAiland/compare-ocrs/funsd_cache"
